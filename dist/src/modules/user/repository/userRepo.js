...
exports.getUserByEmail = exports.deleteUserById = exports.getUserById = exports.getAllUsers = exports.createUser = void 0;
const user_1 = __importDefault(require("../../../database/models/user"));
const createUser = (body) => __awaiter(void 0, void 0, void 0, function* () {
    return yield user_1.default.create(body);
});
